    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto px-6">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                ...
                <form action="{{ route('trajets.update',$trajet) }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="ville_depart" value="{{ old('ville_depart',$trajet->ville_depart) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="ville_arrivee" value="{{ old('ville_arrivee',$trajet->ville_arrivee) }}"
                               class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        @error('ville_arrivee')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" min="1" name="places_disponibles" value="{{ old('places_disponibles',$trajet->places_disponibles) }}"
                               class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="jours_recurrence" value="{{ old('jours_recurrence',$trajet->jours_recurrence) }}"
                               class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
